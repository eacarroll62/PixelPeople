...
struct AnimalCategoryFilter: View {
...
struct AnimalCategoryFilter_Previews: PreviewProvider {
    static var previews: some View {
        AnimalCategoryFilter(animals: Animals(), isPresented: .constant(true), filter: .aquatic)
    }
}
