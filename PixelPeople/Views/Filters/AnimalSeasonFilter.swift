...
struct AnimalSeasonFilter: View {
...
struct AnimalSeasonFilter_Previews: PreviewProvider {
    static var previews: some View {
        AnimalSeasonFilter(animals: Animals(), isPresented: .constant(true), filter: .frost)
    }
}
